...
because the drivers (chromeos_laptop, chromeos_pstore) in version 3.14
of the kernel have not been updated yet.  Patches to add support have
been created by Benson Leung and are in the process of being added.
As of this writing, the linux-next branch includes the patches, so a
custom kernel can be compiled [[9]] to get support.
