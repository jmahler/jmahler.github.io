...
In conclusion, the manual method is better suited to developers where
rebuild time is important.  For distributing a kernel the .deb method is
better because of the clean install/remove process.
