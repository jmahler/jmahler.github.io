...
The are several ways to build a kernel.  On a Debian system the
`make-kpkg` (from kernel-package) can be used and it will produce a .deb
that will install and setup Grub correctly.  This is the preferred
method.
